...
for show in showCatalog {
    showCatalogLowercased.append(show.lowercased())
}
...
var errorDataTabulatorLowercased = Tabulator()

for value in surveyDataTabulatorLowercased.values {
    if showCatalogLowercased.contains(value) {
        surveyValidDataTabulatorLowercased.incrementCount(forValue: value)
    } else {
        errorDataTabulatorLowercased.incrementCount(forValue: value)
    }
}
print(surveyValidDataTabulatorLowercased.values)

print("\n\n***** DATA ERRORS ******\n\n")

// Print the error count.
print(errorDataTabulatorLowercased.values)
/*:
