...
tabulator.incrementCount(forValue: "100 Stories About One Night")
tabulator.incrementCount(forValue: "Beneath")
tabulator.incrementCount(forValue: "Ocean Express")
tabulator.incrementCount(forValue: "Beneath")
tabulator.incrementCount(forValue: "Beyond the Night")
tabulator.incrementCount(forValue: "Finding Alyssa")
tabulator.incrementCount(forValue: "Ocean Express")
