...
print("Not very popular shows (range of counts: 0-\(median - medianAbsoluteDeviation)) — \(notVeryPopular)\n")
print("Moderately popular shows (range of counts: \(median - medianAbsoluteDeviation)-\(median + medianAbsoluteDeviation)) — \(moderatelyPopular)\n")
print("Very popular shows (range of counts: \(median + medianAbsoluteDeviation) and more) — \(veryPopular)\n")
